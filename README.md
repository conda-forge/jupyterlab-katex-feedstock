...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab-katex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12276&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab-katex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab-katex` can be installed with:

```
conda install jupyterlab-katex
```

It is possible to list all of the versions of `jupyterlab-katex` available on your platform with:
